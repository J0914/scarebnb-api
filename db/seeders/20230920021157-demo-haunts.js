...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Haunts', [
      ...
      {
        hostId: 2,
        title: 'Peaceful Getaway W/ Private Fishing & Gameroom',
      ...
      {
        hostId: 3,
        title: 'Luxury Treehouse Couples Getaway w/ Peaceful Views',
      ...
      {
        hostId: 1,
        title: 'Voted # 1 House-Pool, Bowling, Golf, Basketball',
      ...
      {
        hostId: 2,
        title: 'Luxury Frozen & Harry Potter Villa in Reunion',
      ...
      {
        hostId: 1,
        title: 'Your Private Resort! Splash Zone, Playground, Golf',
      ...
      {
        hostId: 2,
        title: 'The Sandy Dollar - Stunning Direct BEACHFRONT Home with Ocean and Beach Views For Miles!',
      ...
      {
        hostId: 3,
        title: 'BeachFront*New 7 Person Hot Tub*Arcades*Foosball*',
